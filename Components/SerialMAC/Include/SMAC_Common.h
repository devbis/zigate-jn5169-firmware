...
/***        Exported Functions                                            ***/
/****************************************************************************/
PUBLIC void vSMAC_OnTx(bool_t bOn);
PUBLIC void vSMAC_OnRx(bool_t bOn);
PUBLIC void vSMAC_Heartbeat(void);
PUBLIC void DEBUG_ASSERT(uint32 u32Exp, string szDbgMsg);
PUBLIC void DEBUG_EnhancedDebugTrace(uint8* pu8Buffer, uint32 u32Size);
