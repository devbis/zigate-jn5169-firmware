...
INSECURE_DEV_RAW_PDM=${INSECURE_DEV_RAW_PDM:-0}
OCB_TYPED_SUPPORT=${OCB_TYPED_SUPPORT:-1}
OCB_KEY_EXPORT_RESTORE_EXPERIMENTAL=${OCB_KEY_EXPORT_RESTORE_EXPERIMENTAL:-0}
...
exec make -j1 "$ACTION" \
    ...
    INSECURE_DEV_RAW_PDM="$INSECURE_DEV_RAW_PDM" \
    OCB_TYPED_SUPPORT="$OCB_TYPED_SUPPORT" \
    OCB_KEY_EXPORT_RESTORE_EXPERIMENTAL="$OCB_KEY_EXPORT_RESTORE_EXPERIMENTAL"
